...
m0_null <- readRDS(here::here("models", "m0_null_pooled.rds"))
m1_moisture <- readRDS(here::here("models", "m1_moisture_pooled.rds"))
m2_temporal <- readRDS(here::here("models", "m2_temporal_pooled.rds"))
m3_history <- readRDS(here::here("models", "m3_history_pooled.rds"))
m4_energy <- readRDS(here::here("models", "m4_energy_pooled.rds"))
m5_wind <- readRDS(here::here("models", "m5_wind_pooled.rds"))
